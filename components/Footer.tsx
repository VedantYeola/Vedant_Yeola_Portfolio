    ...
    <footer className="bg-zinc-100 dark:bg-black border-t border-zinc-200 dark:border-zinc-900 py-16 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="flex gap-8 mb-8">
           ...
           <a href="/Vedant_Yeola_CV.pdf" target="_blank" rel="noreferrer" className="text-zinc-500 dark:text-zinc-500 hover:text-black dark:hover:text-white transition-colors">
             <FileText size={20} />
           </a>
